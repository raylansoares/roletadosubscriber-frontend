...
export default {
  ...
  data: () => ({
    ...
    defaultPrizes: [
      ...
      { color: "#0172ac", enabled: true, name: "Jogo Gratuito", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      ...
      { color: "#0172ac", enabled: true, name: "BG temático", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#ffffff", enabled: true, name: "Escolha 2 músicas", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#f07e26", enabled: true, name: "De timeout em alguém", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#ffffff", enabled: true, name: "10 minutos de timeout", message: "{user} ganhou {prize}!", command: "/timeout {user} 600", delay: 15 },
      { color: "#fb426e", enabled: true, name: "Imagem para o cromakey", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#ffffff", enabled: true, name: "Pergunte ao Tesdey", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#f2d809", enabled: true, name: "Desenho na cara", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#ffffff", enabled: true, name: "Frase de encerramento", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
      { color: "#0172ac", enabled: true, name: "Duelo com Tesdey", message: "{user} ganhou {prize}!", command: "!whisp {user}", delay: 1 },
    ],
    selectedItem: null
  }),
